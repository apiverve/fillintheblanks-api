...
// Request contains the parameters for the Fill in the Blanks Generator API.
//
// Parameters:
...
// ResponseData contains the data returned by the Fill in the Blanks Generator API.
...
type PuzzlesItem struct {
	...
	FirstLetter interface{} `json:"firstLetter"`
}
