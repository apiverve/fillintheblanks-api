...
namespace APIVerve\Fillintheblanks;
...
/**
 * Client for the Fill in the Blanks Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/fillintheblanks?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/fillintheblanks';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\FillintheblanksClient] {$message}\n";
        }
    }
}
