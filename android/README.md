# Fill in the Blanks Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:fillintheblanks-api:1.1.12'
}
```
...
```java
import com.apiverve.fillintheblanks.FillintheBlanksGeneratorAPIClient;
import com.apiverve.fillintheblanks.APIResponse;
import com.apiverve.fillintheblanks.APIException;

// Initialize the client
FillintheBlanksGeneratorAPIClient client = new FillintheBlanksGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/fillintheblanks](https://docs.apiverve.com/ref/fillintheblanks)
...
- **Documentation:** [https://docs.apiverve.com/ref/fillintheblanks](https://docs.apiverve.com/ref/fillintheblanks)
- **Issues:** [GitHub Issues](https://github.com/apiverve/fillintheblanks-api/issues)
