...
namespace APIVerve.API.FillintheBlanksGenerator
{
    ...
    /// <summary>
    /// Client for the FillintheBlanksGenerator API
    /// </summary>
    public class FillintheBlanksGeneratorAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/fillintheblanks";
        ...
        public FillintheBlanksGeneratorAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public FillintheBlanksGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public FillintheBlanksGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, FillintheBlanksGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(FillintheBlanksGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(FillintheBlanksGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(FillintheBlanksGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(FillintheBlanksGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(FillintheBlanksGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(FillintheBlanksGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(FillintheBlanksGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(FillintheBlanksGeneratorQueryOptions options)
        {
