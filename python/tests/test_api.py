...
class TestFillintheblanksAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = FillintheblanksAPIClient(self.api_key)

    @patch('apiverve_fillintheblanksgenerator.apiClient.requests.get')
